...
const TopFoodsDtl = () => {
    ...
    return (
        <div className="mb-10">
            ...
            <Link to='/'><button className="btn bg-yellow-500 font-bold uppercase text-white ml-[600px] hover:text-yellow-500 hover:border-yellow-500 hover:bg-white mt-10">Back</button></Link>
        </div>
    );
};
